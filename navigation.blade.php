<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard_search')" :active="request()->routeIs('dashboard_search')">
                        {{ __('dashboard_search') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else {{-- <--- Tambahkan ini jika Anda ingin menampilkan sesuatu saat tidak login --}}
                    {{-- Contoh: Tombol login atau register --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard_search')" :active="request()->routeIs('dashboard_search')">
                {{ __('dashboard_search') }}
