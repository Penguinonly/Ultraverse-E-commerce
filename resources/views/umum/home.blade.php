...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/umum/home.css') }}">
</head>
<body>
  <header>
  ...
  <div class="container">
    <div class="section-wrapper"></div>
      <section class="section">
        <img src="pexels-elevate-digital-784230-1647907.jpg" alt="Team discussing real estate" />
      ...
      <section class="section reverse">
        <img src="pexels-fauxels-3184291.jpg" alt="Meeting and handshake" />
        <div class="section-text">
  ...
  <footer>
    <div class="container">
      <div class="footer-logo">
        <!-- Footer Logo Image -->
        <img src="Logo.png" alt="InHouse Logo" class="footer-logo-img" />
