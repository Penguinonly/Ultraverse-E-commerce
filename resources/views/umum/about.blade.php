...
<body>
  ...
  <header>
    <div class="container nav">
      <a href="#" class="logo">
        <img src="Logo.png" alt="InHouse Logo" class="logo-img" />
        <span class="brand">InHouse</span>
      </a>
      <nav class="nav-links">
        <a href="../Home/home.html">Home</a>
        <a href="../Service/service.html">Service</a>
        <a href="../About/aboutUS.html" class="active">About us</a>
      </nav>
  ...
  <section class="hero-about">
    <img src="LogoHitam.png" alt="InHouse Symbol" class="hero-logo" />
  ...
  <section class="team container">
    ...
    <div class="team-members">
      <!-- Member Card -->
      <div class="member">
        <img src="Yuki Kirei Nasruddin.jpeg" alt="Yuki Kirei Nasruddin" />
        <h3>Yuki Kirei Nasruddin</h3>
        <p class="role">Project Manager</p>
      </div>
      <div class="member">
        <img src="Andi Muhammad Rifai.jpg" alt="Andi Muhammad Rifai" />
        <h3>Andi Muhammad Rifai</h3>
        <p class="role">Database Engineer</p>
      </div>
      <div class="member">
        <img src="Safri Nur Saputra.jpg" alt="Safri Nur Saputra" />
        <h3>Safri Nur Saputra</h3>
        <p class="role">System Analyst & QA Specialist</p>
      </div>
      <div class="member">
        <img src="Gian Hervicky Thamrin.jpg" alt="Gian Hervicky Thamrin" />
        <h3>Gian Hervicky Thamrin</h3>
        <p class="role">Backend Programmer</p>
      </div>
      <div class="member">
        <img src="Riska Haniriadi.jpg" alt="Riska Haniriadi" />
  ...
  <footer>
    <div class="container footer-content">
      <div class="footer-logo">
        <img src="Logo.png" alt="InHouse Logo" />
        <span>InHouse</span>
      </div>
